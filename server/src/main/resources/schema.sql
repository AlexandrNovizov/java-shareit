...
CREATE TABLE IF NOT EXISTS request_items (
    ...
    item_id BIGINT NOT NULL,
    CONSTRAINT pk_request_items PRIMARY KEY (request_id, item_id),
    CONSTRAINT fk_response_request FOREIGN KEY (request_id) REFERENCES requests(id),
    CONSTRAINT fk_response_item FOREIGN KEY (item_id) REFERENCES items(id)
);